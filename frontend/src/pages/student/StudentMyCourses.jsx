                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {enrollments.map((course) => (
                                <div key={course.id}
                                    ...
                                    <div className={`h-40 ${course.id % 2 === 0 ? 'bg-gray-900' : 'bg-gray-200'} relative overflow-hidden`}>
                                        <img alt={course.title} className={`w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 ${course.id % 2 === 0 ? 'opacity-80' : ''}`} src={course.thumbnail} />
